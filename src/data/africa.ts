export const africa = {
  name: 'África',
  description: `No continente africano, podem ser encontradas faixas de floresta equatorial; savanas que predominam na maior parte do continente; vegetação mediterrânea; e estepes.`,
  total_of_countries: 54,
  total_of_languages: 2092,
  cities_over_hundred: 8,
  img: 'https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1467&q=80',
  cities: [
    {
      name: 'Cidade do Cabo',
